...
import {ERROR_MESSAGES, FileState, MultipleInputProps, variants} from "@/app/ui/components/edgestore/config";

const MultiImageDropzone = React.forwardRef<HTMLInputElement, MultipleInputProps>(
    (
        ...
        //sm:grid-cols-[repeat(2,1fr)] lg:grid-cols-[repeat(3,1fr)] xl:grid-cols-[repeat(4,1fr)]
        return (
            <div>
                    ...
                    {value?.map(({file, progress}, index) => (
                        ...
                        >
                            ...
                            {typeof progress === 'number' && (
                                <div
                                    className="absolute top-0 left-0 flex h-full w-full items-center justify-center rounded-md bg-black bg-opacity-70">
                            ...
                            {imageUrls[ index ] && !disabled && progress === 'PENDING' && (
                                ...
                                >
                                    <div
                                        className="flex h-5 w-5 cursor-pointer items-center justify-center rounded-md border border-solid border-gray-500 bg-white transition-all duration-300 hover:h-6 hover:w-6 dark:border-gray-400 dark:bg-black">
                                        <X
...
export {MultiImageDropzone as default};