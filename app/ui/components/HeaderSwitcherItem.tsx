...
export default function HeaderSwitcherItem({Icon, text, url}: HeaderSwitcherItem) {
    ...
    return (
        <Link href={url} onClick={closeDropdown} className={clsx(["w-full hover:bg-neutral flex items-center py-3 px-2 gap-3", (url === pathname || url !== "/" && pathname.startsWith(url)) && "bg-primary hover:bg-primary"])} >
